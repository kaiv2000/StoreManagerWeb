...
<spring:url value="/update-goods-${goods.id}?productType=Accessories" var="updateUrl"/>
<spring:url value="/delete-goods-${goods.id}?productType=Accessories" var="deleteUrl"/>

<spring:url value="/cell-product-${goods.id}?productType=Accessories" var="cellUrl"/>
<spring:url value="/return-product-${goods.id}?productType=Accessories" var="returnUrl"/>

<spring:url value="/print-${goods.id}?productType=Accessories" var="printLabel"/>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">${goods.id}</div>
    </div>

    <div class="row">
        <label class="col-sm-2">Назва</label>
        <div class="col-sm-10">${goods.name}</div>
    </div>
    ...
    <div class="row">
        <label class="col-sm-2">Місце продажі товару</label>
