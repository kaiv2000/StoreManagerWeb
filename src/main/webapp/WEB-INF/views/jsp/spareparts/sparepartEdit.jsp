...
<div class="container">
    ...
    <spring:url value="/saveSparePart" var="productActionUrl" />
    ...
    <form:form class="form-horizontal" method="post" modelAttribute="goodsForm" action="${productActionUrl}">
        ...
        <spring:bind path="startQuantity">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                ...
                <div class="col-sm-10">
                    <form:input min="1" max="100000" path="startQuantity" class="form-control" id="quantity" type="number" title="Кількість товару - тільки цифри" placeholder="Введіть кількість товарів" />
